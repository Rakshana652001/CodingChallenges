...
public class StreamTest {
    public static void main(String[] args) {
        ...
        *****************************************************/
        ...
        Optional<Student> studentsss = students.stream().filter(std->std.getName().equals("Rakshana")).findFirst();
        System.out.println(studentsss.isPresent()?studentsss.get().getName():"NO");
        ...
        *****************************************************/
        List<Student> stud2 = students.stream().filter(student11 -> student11.getMobileNumbers().stream().anyMatch(x -> Objects.equals(x.getNumber(), "3333"))).collect(Collectors.toList());
        ...
        *****************************************************/
        ...
        List<Student> studentList = tmpStudents.stream().map(tmpStud -> new Student(tmpStud.name, tmpStud.age, tmpStud.address, tmpStud.mobileNumbers)).collect(Collectors.toList());
